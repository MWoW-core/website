...
<body class="bg-black cursor-gauntlet" data-spy="scroll" data-target="#app" data-offset="50">
<div id="app">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item mx-2">
                        <a href="magnet:?xt=urn:btih:b296ea8947b36c68f6e022f5a642ecc406ad8968&dn=World%20of%20Warcraft%203.3.5a%20%28no%20install%29">
                            {{ __('Download 3.3.5a') }}
                        </a>
                    </li>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                        ...
                        @endif
                    @else
                        @livewire('notifications-link')

                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="d-block d-md-flex text-center nav-link dropdown-toggle"
                               href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{ Auth::user()->photo_url }}" class="dropdown-toggle-image nav-profile-photo"
                                     alt="{{__('User Photo')}}"/>
                            </a>

                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                @can('viewHorizon')
                                    <a href="{{ route('horizon.index') }}" class="dropdown-item">
                                        <img src="/vendor/horizon/img/favicon.png" alt="Laravel Horizon Icon"
                                ...
                                @can('viewTelescope')
                                    <a href="{{ route('telescope') }}" class="dropdown-item">
                                        <img src="/vendor/telescope/favicon.ico" alt="Laravel Telescope Icon"
                                             width="15px" height="15px">
                                        {{ __('Telescope') }}
                                    </a>
                                @endcan
    ...
    <header class="text-center text-dark"
            style="background-image: url('{{ Storage::url("header.png") }}'); background-size: cover; height: 35vh;">
            <span class="mt-4">
                <h1 class="display-4">{{ config('app.name') }}</h1>
                <p class="lead">{{ __('WoW Private server') }}</p>
            </span>
    </header>
...
<footer class="py-4 bg-dark text-white-50 flex-shrink-0">
    ...
    <div class="container text-center">
        <small>{!! __('Copyright &copy; :year', ['year' => date('Y')]) !!}</small>
        |
        <a href="https://azerothcore.org">
            {{ __('Powered by') }} <img
                src="https://raw.githubusercontent.com/azerothcore/azerothcore.github.io/master/images/logo-github.png"
                alt="AzerothCore" height="30px" width="50px"/>
        </a>
    </div>
</footer>
</body>
